...
public int getColumnCount(){
    try{
        ...
        System.out.println("getColumncount resultset generating error while getting column count");//en cas d'erreur on recoit ce message
...
public int getRowCount(){
    try{
        if(rs == null){
            ...
            return rs.getRow();  // get the row count
